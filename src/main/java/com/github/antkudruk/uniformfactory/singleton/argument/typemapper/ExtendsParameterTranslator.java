...
public class ExtendsParameterTranslator<A> implements SingleParameterTranslator<A> {
    ...
    public ExtendsParameterTranslator(Class<?> originParameterClass, Function<A, ?> translator) {
